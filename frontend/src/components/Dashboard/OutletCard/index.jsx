    ...
    return location ? (
        ...
        <div className="">
            ...
            <img
                ...
                src={"http://"+ process.env.REACT_APP_BACKEND_HOSTNAME + ":8000" + vendor.banner} alt="Background of the outlet" />
        </div>
        ...
        <div className="p-4 flex flex-col gap-4">
            <div className="flex gap-4 items-center">
                ...
                <img
                    ...
                    src={"http://"+ process.env.REACT_APP_BACKEND_HOSTNAME + ":8000" + vendor.icon}
