export function StandoutButton({ children, disabled=false, ...props }) {
    return (
        <button
            className={
                !disabled ? 
                    "bg-exeterBrightGreen bg-gradient-to-r from-exeterDeepGreen via-exeterBrightGreen to-exeterHighlightGreen text-white flex gap-4 justify-center self-center items-center p-4 rounded-2xl text-lg font-semibold w-full"
