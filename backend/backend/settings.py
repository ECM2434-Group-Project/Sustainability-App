...
EMAIL_HOST_USER = 'replatenoreply@gmail.com'  # SMTP username
EMAIL_HOST_PASSWORD = 'ixtk nlom ybuv ubxl '  # SMTP password ( Uses app password gmail)
DEFAULT_FROM_EMAIL = 'replatenoreply@gmail.com'  # Default sender email address